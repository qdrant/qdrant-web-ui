            ...
            <DialogContent>
                <Box>
                    <FormControlLabel control={
                        <Switch checked={isAccessible} onChange={(e) => setIsAccessible(e.target.checked)} />
                    } label="Allow access" />
                </Box>

                <Box sx={{ mb: 1 }}>
                    <FormControlLabel disabled={!isAccessible} control={
                        <Switch checked={isWritable} onChange={(e) => setIsWritable(e.target.checked)} />
                ...
                <Box sx={{ mb: 2 }}>
                    <Typography
                        variant="h6"
                        color={isAccessible ? 'textPrimary' : 'textSecondary'}
                    >
                        Payload Filters
                    </Typography>
                </Box>
