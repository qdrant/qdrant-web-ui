export const title = "Advanced Filtering - Nested Filters"

# {title}

## Step 1: Create a Collection

Start by creating a collection named `dinosaurs` with a vector size of 4 and a distance metric set to `Dot`:
