    ...
    <div>
      ...
      >
        <DialogTitle id="Delete-collection-confirmation">
          Do you want to <Box component="span" display={"inline"} sx={{ color: 'error.main' }}>Delete {collectionName}</Box>?
        </DialogTitle>
        <DialogContent>
          <DialogContentText>
          <Box display={"inline"} component="span" sx={{ color: 'error.main' }}>Warning:</Box> Deleting this database can result in irreversible data loss. Please proceed with caution and ensure that you have a backup of all the necessary data before proceeding. It is recommended to seek professional guidance to avoid any accidental loss of critical data.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
