...
describe("parser", () => {
  ...
  it("given block text: convert it into request - url, body, get params", () => {
    ...
    expect(requests.endpoint).toEqual(
      "http://localhost:6333/collections/demo1"
    );
    ...
    expect(requests.endpoint).toEqual("http://localhost:6333/collections");
    expect(requests.error).toEqual(null);
    expect(requests.reqBody).toEqual({});
    ...
    requests = codeParse(block.blockText);
    expect(requests.method).toEqual(null);
    expect(requests.endpoint).toEqual("http://localhost:6333/");
    expect(requests.error).toEqual("Add method");
